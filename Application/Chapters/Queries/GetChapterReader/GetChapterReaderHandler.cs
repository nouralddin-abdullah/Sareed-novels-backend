...
public class GetChapterReaderHandler(IChaptersRepository chaptersRepository, INovelsRepository novelsRepository, IMapper mapper) : IRequestHandler<GetChapterReaderQuery, ChapterSingleReaderDTO>
{
