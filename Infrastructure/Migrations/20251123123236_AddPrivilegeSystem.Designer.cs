...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251123123236_AddPrivilegeSystem")]
    partial class AddPrivilegeSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.EntityArticle", b =>
                {
                    ...
                    b.HasIndex("EntityId", "OrderIndex")
                        .HasDatabaseName("IX_EntityArticles_Entity_Order");

                    b.ToTable("EntityArticles");
                });

            modelBuilder.Entity("Domain.Entities.EntityGalleryImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("EntityGalleryImages");
                });

            modelBuilder.Entity("Domain.Entities.EntityRelationship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.GiftTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Entities.GlobalSupporterLeaderboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("TotalGiftsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<decimal>("TotalPointsGifted")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
                    ...
                    b.ToTable("GlobalSupporterLeaderboards");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Notification", b =>
                {
                    ...
                    b.Property<string>("ActorProfilePhoto")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Domain.Entities.NovelEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("NovelId", "Section")
                        .HasDatabaseName("IX_NovelEntities_Novel_Section");

                    b.ToTable("NovelEntities");
                });
            ...
            modelBuilder.Entity("Domain.Entities.NovelPrivilegeSubscription", b =>
                {
                    ...
                    b.HasIndex("IsActive", "ExpiresAt")
                        .HasDatabaseName("IX_NovelPrivilegeSubscriptions_Active_Expires");

                    b.HasIndex("NovelId", "UserId")
                        .HasDatabaseName("IX_NovelPrivilegeSubscriptions_Novel_User");

                    b.HasIndex("UserId", "IsActive", "ExpiresAt")
                        .HasDatabaseName("IX_NovelPrivilegeSubscriptions_User_Active_Expires");
            ...
            modelBuilder.Entity("Domain.Entities.RechargeRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal>("BaseAmountEGP")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("PointBalanceLastUpdated")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Domain.Entities.EntityRelationship", b =>
                {
                    b.HasOne("Domain.Entities.NovelEntity", "SourceEntity")
                        .WithMany("SourceRelationships")
                        .HasForeignKey("SourceEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.NovelEntity", "TargetEntity")
